    ...
    render() {
        return (
            <div className="w-full h-xl bg-gray-200 dark:bg-gray-600 flex justify-center items-center rounded">
                <div className={`bg-gradient-to-b from-${this.state.gradient[0]} to-${this.state.gradient[1]} w-full h-xl flex relative z-0 transform  transition-transform duration-500 ease-in-out ${this.state.reversedRotation ? "rotate-2 hover:-rotate-1" : "-rotate-2 hover:rotate-1"} rounded shadow p-8`}>
