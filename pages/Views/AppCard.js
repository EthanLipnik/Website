...
export default class AppCard extends React.Component {
    ...
    render() {
        return (
            <div className={`cursor-pointer w-full h-xl bg-gray-200 dark:bg-gray-600 flex justify-center items-center rounded mx-4 transform transition-transform duration-500 ease-in-out ${this.state.reversedRotation ? "rotate-6" : "-rotate-6"}`}>
